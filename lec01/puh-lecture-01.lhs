...
at the moment, will be difficult to understand for you. The error message will
...
TYPE SYSTEM that prevents you from wrongly mixing pure and impure code. Because
you cannot compile any code unless the type checker approves it, you won't be
even able to compile such code and get it running!
...
Prep homework will be handed out on Saturday!
